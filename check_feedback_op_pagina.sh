...
DTL_BEWUST_NIET=$(echo "nhbapps/templates/snippets.dtl /plein-bezoeker.dtl /niet-ondersteund.dtl /feedback/ /tijdelijke-url- /Logboek/ /Handleiding/ /templates/plein/menu- /account/login-as-zoek.dtl /account/bevestigd.dtl /sporter/registreer-nhb-account.dtl" | tr ' ' '|')
