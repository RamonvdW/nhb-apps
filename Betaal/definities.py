...
TRANSACTIE_TYPE_HANDMATIG = 'HA'
TRANSACTIE_TYPE_MOLLIE_PAYMENT = 'MP'
TRANSACTIE_TYPE_MOLLIE_RESTITUTIE = 'MR'

TRANSACTIE_TYPE_CHOICES = (
    (TRANSACTIE_TYPE_HANDMATIG, 'Handmatig'),
    (TRANSACTIE_TYPE_MOLLIE_PAYMENT, 'Mollie Payment'),
    (TRANSACTIE_TYPE_MOLLIE_RESTITUTIE, 'Mollie Restitutie'),
)
