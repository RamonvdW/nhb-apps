    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('regiocompetitie', models.ForeignKey(on_delete=models.deletion.CASCADE, to='Competitie.regiocompetitie')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aangemeld_door', models.ForeignKey(blank=True, null=True, on_delete=models.deletion.SET_NULL, to='Account.account')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gemiddelde', models.DecimalField(decimal_places=3, default=0.0, max_digits=5)),
                ('kampioenschap', models.ForeignKey(on_delete=models.deletion.CASCADE, to='Competitie.kampioenschap')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vereniging', models.ForeignKey(on_delete=models.deletion.PROTECT, to='NhbStructuur.nhbvereniging')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deelnemers_feitelijk', models.ManyToManyField(blank=True, related_name='teamronde_feitelijk', to='Competitie.regiocompetitiesporterboog')),
                ('deelnemers_geselecteerd', models.ManyToManyField(blank=True, related_name='teamronde_geselecteerd', to='Competitie.regiocompetitiesporterboog')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feitelijke_leden', models.ManyToManyField(blank=True, related_name='kampioenschapteam_feitelijke_leden', to='Competitie.kampioenschapsporterboog')),
                ('gekoppelde_leden', models.ManyToManyField(blank=True, related_name='kampioenschapteam_gekoppelde_leden', to='Competitie.kampioenschapsporterboog')),
                ('tijdelijke_leden', models.ManyToManyField(blank=True, related_name='kampioenschapteam_tijdelijke_leden', to='Competitie.regiocompetitiesporterboog')),
                ('result_rank', models.PositiveSmallIntegerField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('regiocompetitie', models.ForeignKey(blank=True, null=True, on_delete=models.deletion.CASCADE, to='Competitie.regiocompetitie')),
                ...
                ('kampioenschap', models.ForeignKey(blank=True, null=True, on_delete=models.deletion.CASCADE, to='Competitie.kampioenschap')),
