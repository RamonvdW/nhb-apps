...
MUTATIE_KLEINE_KLASSE_INDIV = 80
MUTATIE_KLEINE_KLASSE_TEAM = 81
...
MUTATIE_TO_STR = {
    ...
    MUTATIE_KLEINE_KLASSE_INDIV: "kleine klasse indiv",
    MUTATIE_KLEINE_KLASSE_TEAM: "kleine klasse team",
}
