...
VERZENDKOSTEN_PAKKET_GROOT = "groot"
VERZENDKOSTEN_PAKKET_KLEIN = "klein"
VERZENDKOSTEN_ENVELOP = "nvlop"
...
VERZENDKOSTEN_CHOICES = (
    ...
    (VERZENDKOSTEN_PAKKET_KLEIN, "Pakket 2kg"),
    (VERZENDKOSTEN_PAKKET_GROOT, "Pakket 10kg"),
)
