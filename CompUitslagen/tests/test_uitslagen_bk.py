...
class TestCompUitslagenBK(E2EHelpers, TestCase):
    ...
    def test_ver_indiv(self):
        ...
        url2 = self.url_uitslagen_rayon % (self.testdata.comp18.pk, 'R')
        with self.assert_max_queries(20):
    ...
    def test_rcl_rko(self):
        functie = self.testdata.comp18_functie_rcl[111]
        self.e2e_login_and_pass_otp(self.testdata.account_bb)
        self.e2e_wissel_naar_functie(functie)
        ...
        functie = self.testdata.comp18_functie_rko[3]
        self.e2e_wissel_naar_functie(functie)
