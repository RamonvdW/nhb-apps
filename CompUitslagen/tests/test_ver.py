...
class TestCompUitslagenVer(E2EHelpers, TestCase):
    ...
    def test_ver_indiv(self):
        ...
        self.assert_template_used(resp, ('compuitslagen/vereniging-indiv.dtl', 'design/site_layout.dtl'))
    ...
    def test_ver_teams(self):
        ...
        self.assertEqual(resp.status_code, 200)
        self.assert_html_ok(resp)
        self.assert_template_used(resp, ('compuitslagen/vereniging-teams.dtl', 'design/site_layout.dtl'))
