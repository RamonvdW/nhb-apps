...
class TestCompetitieUitslagen(E2EHelpers, TestCase):
    ...
    url_uitslagen_regio = '/bondscompetities/uitslagen/%s/%s/%s/regio-individueel/'
    url_uitslagen_regio_n = '/bondscompetities/uitslagen/%s/%s/%s/regio-individueel/%s/'
    url_uitslagen_regio_teams = '/bondscompetities/uitslagen/%s/%s/regio-teams/'
    url_uitslagen_regio_teams_n = '/bondscompetities/uitslagen/%s/%s/regio-teams/%s/'
    url_uitslagen_rayon = '/bondscompetities/uitslagen/%s/%s/rayon-individueel/'
    url_uitslagen_rayon_n = '/bondscompetities/uitslagen/%s/%s/rayon-individueel/%s/'
    url_uitslagen_bond = '/bondscompetities/uitslagen/%s/%s/bond/'
    url_uitslagen_ver = '/bondscompetities/uitslagen/%s/%s/vereniging/'
