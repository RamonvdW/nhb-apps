...
BOOGTYPE_AFKORTING_COMPOUND = 'C'
BOOGTYPE_AFKORTING_BAREBOW = 'BB'
BOOGTYPE_AFKORTING_LONGBOW = 'LB'
BOOGTYPE_AFKORTING_TRADITIONAL = 'TR'

BOOGTYPE_AFKORTING2STR = {
    BOOGTYPE_AFKORTING_RECURVE: 'Recurve',
    BOOGTYPE_AFKORTING_COMPOUND: 'Compound',
    BOOGTYPE_AFKORTING_BAREBOW: 'Barebow',
    BOOGTYPE_AFKORTING_LONGBOW: 'Longbow',
    BOOGTYPE_AFKORTING_TRADITIONAL: 'Traditional',
}

BOOGTYPE_AFKORTING2URL = {
    BOOGTYPE_AFKORTING_RECURVE: 'recurve',
    BOOGTYPE_AFKORTING_COMPOUND: 'compound',
    BOOGTYPE_AFKORTING_BAREBOW: 'barebow',
    BOOGTYPE_AFKORTING_LONGBOW: 'longbow',
...
BOOGTYPE_URL2AFKORTING = {
    'recurve': BOOGTYPE_AFKORTING_RECURVE,
    'compound': BOOGTYPE_AFKORTING_COMPOUND,
    'barebow': BOOGTYPE_AFKORTING_BAREBOW,
    'longbow': BOOGTYPE_AFKORTING_LONGBOW,
    'traditional': BOOGTYPE_AFKORTING_TRADITIONAL,
}
