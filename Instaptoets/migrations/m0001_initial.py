    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('antwoord_a', models.CharField(blank=True, default='', max_length=200)),
                ('antwoord_b', models.CharField(blank=True, default='', max_length=200)),
                ('antwoord_c', models.CharField(blank=True, default='', max_length=200)),
                ('antwoord_d', models.CharField(blank=True, default='', max_length=200)),
