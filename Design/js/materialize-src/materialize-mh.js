  ...
  var Sidenav = function (_Component8) {
    ...
    _createClass(Sidenav, [{
      ...
      value: function _isCurrentlyFixed() {
        return this.isFixed && window.innerWidth > 1020;
      }
    }, {
...
;(function ($) {
  ...
  var _defaults = {
    ...
    format: 'd mmmm yyyy',       // NL: 31 december 2020
    //format: 'mmm dd, yyyy',
  ...
  var Datepicker = function (_Component15) {
    ...
    _createClass(Datepicker, [{
      ...
      value: function _renderDateDisplay() {
        ...
        var day = i18n.weekdays[displayDate.getDay()];
        //var day = i18n.weekdaysShort[displayDate.getDay()];
        var month = i18n.months[displayDate.getMonth()];
        //var month = i18n.monthsShort[displayDate.getMonth()];
        var date = displayDate.getDate();
        this.yearTextEl.innerHTML = displayDate.getFullYear();
        this.dateTextEl.innerHTML = day + " " + date + " " + month;    // NL: Zon 5 mei
  ...
  Datepicker._template = ['<div class= "modal datepicker-modal">', '<div class="modal-content datepicker-container">', '<div class="datepicker-date-display">', '<span class="year-text"></span>', '<span class="date-text"></span>', '</div>', '<div class="datepicker-calendar-container">', '<div class="datepicker-calendar"></div>', '<div class="datepicker-footer">', '<button class="btn-flat datepicker-clear" style="visibility: hidden;" type="button"></button>', '<div class="confirmation-btns">', '<button class="btn-flat datepicker-cancel" type="button"></button>', '<button class="btn-flat datepicker-done" type="button"></button>', '</div>', '</div>', '</div>', '</div>', '</div>'].join('');
  ...
  var Timepicker = function (_Component16) {
    ...
    _createClass(Timepicker, [{
      ...
      value: function _pickerSetup() {
        var $clearBtn = $("<button class=\"btn-flat timepicker-clear\" style=\"visibility: hidden;\" type=\"button\" tabindex=\"" + (this.options.twelveHour ? '3' : '1') + "\">" + this.options.i18n.clear + "</button>").appendTo(this.footer).on('click', this.clear.bind(this));
        if (this.options.showClearBtn) {
          $clearBtn.css({ visibility: '' });
        }

        var confirmationBtnsContainer = $('<div class="confirmation-btns"></div>');
        $('<button class="btn-flat timepicker-close" type="button" tabindex="' + (this.options.twelveHour ? '3' : '1') + '">' + this.options.i18n.cancel + '</button>').appendTo(confirmationBtnsContainer).on('click', this.close.bind(this));
        $('<button class="btn-flat timepicker-close" type="button" tabindex="' + (this.options.twelveHour ? '3' : '1') + '">' + this.options.i18n.done + '</button>').appendTo(confirmationBtnsContainer).on('click', this.done.bind(this));
...
/*;(function ($) {
  ...
  var _defaults = {
    duration: 200, // ms
    dist: -100, // zoom scale notmytodo: make this more intuitive as an option
  ...
  var Range = function (_Component21) {
    ...
    _createClass(Range, [{
      ...
      value: function _showRangeBubble() {
        ...
        var marginLeft = -7 + paddingLeft + 'px'; // notmytodo: fix magic number?
        anim.remove(this.thumb);
        anim({
          targets: this.thumb,
          height: 30,
