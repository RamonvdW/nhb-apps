...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('Schutter', 'm0009_voorkeur_disciplines'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('klassen', models.ManyToManyField(blank=True, to='BasisTypen.IndivWedstrijdklasse')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_naam', models.CharField(default='', max_length=50)),
                ('contact_email', models.CharField(default='', max_length=150)),
                ('contact_website', models.CharField(default='', max_length=100)),
                ('contact_telefoon', models.CharField(default='', max_length=50)),
                ('voorwaarden_a_status_acceptatie', models.BooleanField(default=False)),
                ('voorwaarden_a_status_when', models.DateTimeField()),
                ('voorwaarden_a_status_who', models.CharField(default='', max_length=100)),
                ('unmanaged_url', models.CharField(default='', max_length=100)),
                ...
                ('scheidsrechters', models.TextField(default='', max_length=500)),
