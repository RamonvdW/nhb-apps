...
class ReistijdBepalen(object):
    ...
    def __init__(self, stdout, stderr, verzoeken_grens):
        ...
        # while dt.weekday() != 5:      # 5 = zaterdag
        #     dt += datetime.timedelta(days=1)
        # # while
        #
        # # zet de klok naar 00:00:00.00000
        # dt = datetime.datetime.combine(dt.date(), datetime.time(hour=8), tzinfo=dt.tzinfo)
        #
        # self._future_saturday_0800 = dt
    ...
    def _reistijd_met_auto(self, vanaf_lat_lon, naar_lat_lon):
        ...
        try:
            ...
            mins = 16 * 60      # geef een gek getal terug wat om aandacht vraagt
        else:
...
class ReistijdBepalenV1(object):
