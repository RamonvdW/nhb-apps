...
from Competitie.models import Kampioenschap, CompetitieMatch, KampioenschapSporterBoog, KampioenschapTeam
from Competitie.tijdlijn import bepaal_fase_indiv
