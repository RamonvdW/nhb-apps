...
WEDSTRIJDINSCHRIJVING_STATUS_CHOICES = (
    ...
    (WEDSTRIJDINSCHRIJVING_STATUS_RESERVERING_BESTELD, "Besteld"),
    (WEDSTRIJDINSCHRIJVING_STATUS_DEFINITIEF, "Definitief"),
    (WEDSTRIJDINSCHRIJVING_STATUS_AFGEMELD, "Afgemeld"),
    (WEDSTRIJDINSCHRIJVING_STATUS_VERWIJDERD, "Verwijderd"),
)

WEDSTRIJDINSCHRIJVING_STATUS_TO_STR = {
    WEDSTRIJDINSCHRIJVING_STATUS_RESERVERING_MANDJE: 'Gereserveerd, in mandje',
    WEDSTRIJDINSCHRIJVING_STATUS_RESERVERING_BESTELD: 'Gereserveerd, wacht op betaling',
    WEDSTRIJDINSCHRIJVING_STATUS_DEFINITIEF: 'Inschrijving is definitief',
    WEDSTRIJDINSCHRIJVING_STATUS_AFGEMELD: 'Afgemeld',
    WEDSTRIJDINSCHRIJVING_STATUS_VERWIJDERD: 'Verwijderd',
}

WEDSTRIJDINSCHRIJVING_STATUS_TO_SHORT_STR = {
    WEDSTRIJDINSCHRIJVING_STATUS_RESERVERING_MANDJE: 'In mandje',
    WEDSTRIJDINSCHRIJVING_STATUS_RESERVERING_BESTELD: 'Besteld',
    WEDSTRIJDINSCHRIJVING_STATUS_DEFINITIEF: 'Definitief',
    WEDSTRIJDINSCHRIJVING_STATUS_AFGEMELD: 'Afgemeld',
    WEDSTRIJDINSCHRIJVING_STATUS_VERWIJDERD: 'Verwijderd',
