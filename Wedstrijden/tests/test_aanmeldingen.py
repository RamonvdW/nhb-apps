...
from Wedstrijden.definities import WEDSTRIJDINSCHRIJVING_STATUS_AFGEMELD, WEDSTRIJD_KORTING_VERENIGING
...
class TestWedstrijdenAanmeldingen(E2EHelpers, TestCase):
    ...
    def setUp(self):
        ...
        self.inschrijving2.status = WEDSTRIJDINSCHRIJVING_STATUS_AFGEMELD
    ...
    def test_details_sporter(self):
        ...
        self.inschrijving1c.status = WEDSTRIJDINSCHRIJVING_STATUS_AFGEMELD
