...
class TeamBK(models.Model):
    ...
    kamp = models.ForeignKey(KampBK, on_delete=models.CASCADE)        # nodig voor de migratie
    ...
    team_klasse = models.ForeignKey(CompetitieTeamKlasse,
                                    ...
                                    blank=True, null=True,
                                    related_name='teambk_team_klasse')
    ...
    team_klasse_volgende_ronde = models.ForeignKey(CompetitieTeamKlasse,
                                                   on_delete=models.CASCADE,
                                                   blank=True, null=True,
                                                   related_name='teambk_team_klasse_volgende_ronde')
    ...
    gekoppelde_leden = models.ManyToManyField(DeelnemerRK,
                                              related_name='teambk_gekoppelde_leden',
    ...
    feitelijke_leden = models.ManyToManyField(DeelnemerRK,
                                              related_name='teambk_feitelijke_leden',
                                              blank=True)   # mag leeg zijn
