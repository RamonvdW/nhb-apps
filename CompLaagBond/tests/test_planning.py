...
class TestCompetitiePlanningBond(E2EHelpers, TestCase):
    ...
    def setUp(self):
        ...
        self.deelkamp_bk_25 = KampBK.objects.filter(competitie=self.testdata.comp25).first()
    ...
    def test_wijzig_wedstrijd(self):
        ...
        # geen BK match
        self.deelkamp_bk_18.matches.clear()
        resp = self.client.get(url)
    ...
    def test_verwijder_wedstrijd(self):
        ...
        # verkeerde BKO
        self.deelkamp_bk_25.matches.add(self.match)
        resp = self.client.post(url)
        self.assert404(resp, 'Niet de beheerder')
        self.deelkamp_bk_25.matches.clear()
