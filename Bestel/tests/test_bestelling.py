...
class TestBestelBestelling(E2EHelpers, TestCase):
    ...
    def test_afmelden_voor_betalen(self):
        ...
        self.assertEqual(inschrijving.status, WEDSTRIJDINSCHRIJVING_STATUS_RESERVERING_MANDJE)
        ...
        inschrijving = WedstrijdInschrijving.objects.get(pk=self.inschrijving.pk)
        self.assertEqual(inschrijving.status, WEDSTRIJDINSCHRIJVING_STATUS_RESERVERING_BESTELD)
        ...
        inschrijving = WedstrijdInschrijving.objects.get(pk=self.inschrijving.pk)
        self.assertEqual(inschrijving.status, WEDSTRIJDINSCHRIJVING_STATUS_VERWIJDERD)
    ...
    def test_afmelden_na_betalen(self):
        ...
        self.verwerk_bestel_mutaties()
        inschrijving = WedstrijdInschrijving.objects.get(pk=self.inschrijving.pk)
        self.assertEqual(inschrijving.status, WEDSTRIJDINSCHRIJVING_STATUS_AFGEMELD)
