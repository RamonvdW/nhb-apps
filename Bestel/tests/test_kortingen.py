...
from Wedstrijden.models import (Wedstrijd, WedstrijdSessie, WedstrijdLocatie,
                                WEDSTRIJD_STATUS_GEACCEPTEERD,
                                WedstrijdInschrijving, INSCHRIJVING_STATUS_AFGEMELD,
                                WedstrijdKorting, WEDSTRIJD_KORTING_VERENIGING, WEDSTRIJD_KORTING_SPORTER,
...
class TestBestelKortingen(E2EHelpers, TestCase):
    ...
    def setUp(self):
        ...
        mandje, is_created = BestelMandje.objects.get_or_create(account=self.account_sporter1)
        self.mandje = mandje
    ...
    def test_mandje(self):
        ...
        inschrijving1 = WedstrijdInschrijving.objects.get(pk=inschrijving1_sporter1.pk)
        self.assertEqual(inschrijving1.status, INSCHRIJVING_STATUS_AFGEMELD)
