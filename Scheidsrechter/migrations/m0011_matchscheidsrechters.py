    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gekozen_hoofd_sr', models.ForeignKey(blank=True, null=True, on_delete=models.deletion.SET_NULL, related_name='match_gekozen_hoofd_sr', to='Sporter.sporter')),
                ('gekozen_sr1', models.ForeignKey(blank=True, null=True, on_delete=models.deletion.SET_NULL, related_name='match_gekozen_sr1', to='Sporter.sporter')),
                ('gekozen_sr2', models.ForeignKey(blank=True, null=True, on_delete=models.deletion.SET_NULL, related_name='match_gekozen_sr2', to='Sporter.sporter')),
