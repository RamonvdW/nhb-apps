...
from Bestelling.definities import BESTELLING_REGEL_CODE_EVENEMENT, BESTELLING_KORT_BREAK
...
class EvenementBestelPlugin(BestelPluginBase):
    ...
    def annuleer(self, regel: BestellingRegel):
        ...
        self.stdout.write('[INFO] EvenementInschrijving pk=%s wordt verwijderd' % inschrijving.pk)
        inschrijving.delete()
