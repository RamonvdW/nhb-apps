...
DTL_INCLUDES=$(echo "/menu.dtl /andere-sites.dtl /site_layout.dtl /site_layout_minimaal.dtl /site_layout_favicons /site_layout_fonts /fout_403.dtl /fout_404.dtl /fout_500.dtl /card_icon.dtl /card_logo.dtl /card_icon_beschikbaar-vanaf /card_logo_beschikbaar-vanaf /ga-naar-live-server.dtl /card_product.dtl /card_niet-beschikbaar /tijdlijn.dtl /vhpg-tekst.dtl design/check_js_enabled.dtl" | tr ' ' '|')
DTL_BEWUST_NIET=$(echo "/templates/email Site/templates/snippets.dtl /plein-bezoeker.dtl /niet-ondersteund.dtl /feedback/ tijdelijkecodes/code- /Logboek/ /records_specifiek.dtl /registreer-gast.dtl /registreer-normaal.dtl plein/test- /privacy/verklaring.dtl" | tr ' ' '|')
