...
TEMPLATE_COMPBEHEER_STATISTIEK_TABELLEN = 'compbeheer/statistiek-tabellen.dtl'
TEMPLATE_COMPBEHEER_STATISTIEK_GRAFIEKEN = 'compbeheer/statistiek-grafieken.dtl'


class CompetitieStatistiekView(UserPassesTestMixin, TemplateView):
    """ Deze view biedt statistiek aan over de bondscompetities """

    # class variables shared by all instances
    template_name = TEMPLATE_COMPBEHEER_STATISTIEK_TABELLEN
    ...
    def get_context_data(self, **kwargs):
        ...
        context['url_grafieken'] = reverse('CompBeheer:statistiek-grafieken')
...
class CompetitieGrafiekView(UserPassesTestMixin, TemplateView):
    """ Deze view biedt grafieken aan over de competities """

    # class variables shared by all instances
    template_name = TEMPLATE_COMPBEHEER_STATISTIEK_GRAFIEKEN
    raise_exception = True      # genereer PermissionDenied als test_func False terug geeft
    permission_denied_message = 'Geen toegang'
    ...
    def get_context_data(self, **kwargs):
        ...
        context['url_tabellen'] = reverse('CompBeheer:statistiek-tabellen')

        context['kruimels'] = (
            (reverse('Competitie:kies'), mark_safe('Bonds<wbr>competities')),
            (reverse('CompBeheer:statistiek-tabellen'), 'Statistiek'),
            (None, 'Grafieken')
        )
